...
class HashTable{
    ...
    insert = (name,score) => {
        ...
        if (this.classes[classroom].length < this.classSize){
            ...
            this.classes[classroom].push({name: name, score: score});
        }else {
...
// console.log(Object.values(table.classes)); // to print out the object, object.values access the values of the object directly
